...
const WalkthroughScreen = props => {
  ...
  const _renderNextButton = () => {
    return <Text style={styles.button}>{localized('Suivant')}</Text>
  }

  const _renderSkipButton = () => {
    return <Text style={styles.button}>{localized('Ignorer')}</Text>
  }

  const _renderDoneButton = () => {
    return <Text style={styles.button}>{localized('Terminé')}</Text>
  }
