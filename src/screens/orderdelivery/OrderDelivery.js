...
import { useCurrentUser, useCurrentOrder } from '../../Core/onboarding'
...
const OrderDelivery = ({ route }) => {
  ...
  useEffect(() => {
    ...
    //   console.log('componentDidMount ', currentUser?.location)
    //   // subscribeToPubNub();
  ...
  function renderMap() {
    // delivery boy icon
    console.log('Origin ---> ', coordinates[0])
    console.log('Destination ---> ', coordinates[0])
    console.log('From Location ---> ', fromLocation)
    console.log('To Location ---> ', toLocation)

    const deliveryBoy = () => (
      <Marker.Animated coordinate={fromLocation}>
